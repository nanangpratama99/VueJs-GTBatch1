<template>
        <div style="border-radius: 15px;" class="bg-white p-3 justify-content-around pt-0 pb-3 shadow p-3 mb-5 bg-white">
            ...
            <button class="btn btn-outline-danger ml-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-heart-fill mr-2" viewBox="0 0 16 16">
